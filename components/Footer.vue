  ...
  >
    <div class="border-b">
      ...
      <div class="mx-auto grid max-w-[2400px] grid-cols-2">
        ...
        <a href="https://www.pantown.com/" target="_blank" class="m-auto">
          <img
        ...
        <a href="https://www.pantipmarket.com/" target="_blank" class="m-auto">
          <img
        ...
        <a href="https://maggang.com/" target="_blank" class="m-auto">
          <img
